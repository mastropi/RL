...
class Test_EstDifferentialValueFunctions_EnvGridworld2DWithObstacles(unittest.TestCase, test_utils.EpisodeSimulation):
    ...
    def setUpClass(cls):
        ...
        # TODO: (2025/07/16) Define whether these results are better than the above ones. These results are obtained when in LeaMCLambda._reset_at_start_of_episode() NO reset is done of the return values history, _G_list and _Glambda_list, under the CONTINUING learning tasks (currently disabled)
        # cls.expected_mc_V = [0.479157  , 0.84636579, 0.86671155, 0.,
        #                      0.45300824, 0.        , 0.57838107, 0.33427492,
        #                      0.41393754, 0.15794445, 0.07287564, 0.22280485]
        # cls.expected_mc_Q = [[ 0.344493392,  0.879032258,  0.584524123, 0.222278306 ],
        #                      [ 0.929721816,  0.740273838,  0.610115219, 0.0         ],
        #                      [ 0.0,          0.963518235,  0.630425484, 0.720338983 ],
        #                      [ 0.        ,   0.        ,   0.        ,  0.          ],
        #                      [ 0.458483033,  0.177535571, -0.193659373, 0.0595649661],
        #                      [ 0.,           0.,           0.,          0.          ],
        #                      [ 0.912790698,  0.0,          0.586008499, 0.151649781 ],
        #                      [ 0.0,          0.558982917,  0.209641256, 0.358834244 ],
        #                      [ 0.431773289,  0.136726664,  0.160727507, 2.79600347e-05],
        ...
        cls.expected_td_Q =   [[ 0.09616464,  0.22947858, -0.01262361,  0.09321627],
                               ...
                               [-0.07435124, -0.07539854, -0.07546215, -0.07465943],
        ...
        cls.expected_fv_Q = np.array([ [ 0.00337005,  0.21551403, -0.05941219,  0.00407243],
                                       ...
                                       [-0.03740306, -0.03740784, -0.03736969, -0.03781338],
    ...
    def test_Env_PolRandomWalk_MetFV_SoftKilling(self):
        ...
        assert np.allclose(observed_values_Q, [[-0.05873732,  0.02722446, -0.09710915, -0.05801876],
                                               ...
                                               [-0.10353724, -0.10193253, -0.1036632 , -0.10451193],
